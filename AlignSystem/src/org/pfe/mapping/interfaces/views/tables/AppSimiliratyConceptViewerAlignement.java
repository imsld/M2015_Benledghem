...
import org.pfe.ontologie.SimiliratyConceptInformationAlignement;

public class AppSimiliratyConceptViewerAlignement extends TableViewer {
	public AppSimiliratyConceptViewerAlignement(Composite parent, int style) {
		super(parent, style);
		...
		setContentProvider(new AppSimiliratyConceptAlignementProvider());
	}
	...
	private void createColumns() {
		...
		column.setLabelProvider(new ColumnLabelProvider() {
			public String getText(Object element) {
				if (element instanceof SimiliratyConceptInformationAlignement)
					return ((SimiliratyConceptInformationAlignement) element)
							.getConcept_o1();
